        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <a href="/admin/chat" className="hidden sm:block">
                <button className="px-4 py-2 rounded-lg border border-orange-300 hover:bg-orange-50 transition-colors text-sm font-medium text-orange-600 flex items-center gap-2">
                  ...
                  <span className="hidden md:inline">Чат менеджера</span>
                </button>
              </a>
              ...
              <button
                ...
                className="lg:hidden w-10 h-10 bg-gradient-to-r from-primary to-secondary text-white rounded-lg flex items-center justify-center hover:shadow-lg transition-all"
              >
