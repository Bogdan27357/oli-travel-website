      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a href="/admin/login">
              <button className="px-4 py-2 rounded-lg border border-primary/30 hover:bg-primary/5 transition-colors text-sm font-medium text-primary flex items-center gap-2">
