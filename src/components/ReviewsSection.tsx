...
const fallbackReviews = [
  ...
  { 
    ...
    rating: 5, 
    comment: 'Греция, Крит — просто сказка! Отель с видом на море, вкусная кухня, много экскурсий. Менеджер помог выбрать идеальные даты и отель. Всё чётко, без проблем. Спасибо большое!', 
    date: '2024-08-28',
    country: 'Греция, Крит',
    is_approved: true
  }
